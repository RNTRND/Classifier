...
class Master:
    ...
    def classifiermulticlf(self):
        self.clf = ClassifierMultiCLF.cls(self.df,self.x_train,self.x_test,self.y_train,self.y_test,self.X,self.y)
